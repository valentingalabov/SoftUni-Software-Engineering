...
namespace P04_Hospital
{
    public class Engine
    {
        ...
        public void Run()
        {
            ...
            while (command != "End")
            {
                ...
                if (args.Length == 1)
                {
                    ...
                    PintPatientsInDepartment(departmentName);
                }
        ...
        private void PintPatientsInDepartment(string departmentName)
        {
        ...
        private void AddPatientToRoom(string departament, string patient)
        {
            ...
            for (int currenRoom = 0; currenRoom < departments[departament].Count; currenRoom++)
            {
                if (departments[departament][currenRoom].Count < 3)
                {
                    room = currenRoom;
                    break;
                }
                          ...
                          /*  int targetRoom = departments[departament].SelectMany(x => x).Where(x => x.Count() < 3).FirstOrDefault()*/;
