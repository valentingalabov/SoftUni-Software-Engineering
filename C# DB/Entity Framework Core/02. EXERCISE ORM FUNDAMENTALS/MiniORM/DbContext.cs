...
namespace MiniORM
{
    public abstract class DbContext
    {
        ...
        protected DbContext(string connectionString)
        {
            ...
            dbSetProperties = this.DicoverDbSets();
            ...
            foreach (var foreignKey in foreignKeys)
            {
                ...
                foreach (var entity in dbSet)
                {
                    ...
                    var navigationPropertyValue = ((IEnumerable<Object>)navigationDbSet)
                        .First(vurrentNavigationProperty => navigationPrimaryKey.GetValue(vurrentNavigationProperty).Equals(foreignKeyValue));
        ...
        private Dictionary<Type, PropertyInfo> DicoverDbSets()
        {
