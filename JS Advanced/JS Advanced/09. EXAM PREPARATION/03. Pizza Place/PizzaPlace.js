...
describe("Tests …", function () {
    ...
    it("Get order type", () => {
        ...
        assert.equal(pizzUni.orderType(totalaSum, orderTypeDelivery), 100);
        assert.equal(pizzUni.orderType(totalaSum, orderTypeCarry), 90);

        assert.equal(pizzUni.orderType(totalSum1, orderTypeDelivery), -100);
        assert.equal(pizzUni.orderType(totalSum1, orderTypeCarry), -90);

        assert.equal(pizzUni.orderType(tottalSum2, orderTypeDelivery), 0);
        assert.equal(pizzUni.orderType(tottalSum2, orderTypeCarry), 0);
